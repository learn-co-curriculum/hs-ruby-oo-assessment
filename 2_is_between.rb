# The Integer datatype is it's own class in Ruby and you can "re-open" this class to add new methods.
...
class Integer
  def is_between?(min, max)
    # `self` refers to the number that this method is called on.
